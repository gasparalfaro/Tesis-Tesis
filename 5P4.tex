...
In this chapter we summarize the results obtained in a study that led to the publication of \cite{Alfaro2024}. This study followed the same paths that the one in the previous chapter, but this time with elementary cellular automata, the most simple cellular automata.
