...
This manuscript explores these findings in detail: Section \ref{model} explains how we model strategy evolution and our simulation methods. Section \ref{punish} describes how we calculate individual payoffs and compares different punishment approaches. Sections \ref{oscillating} and \ref{delay} present our findings about oscillating enhancement factors and delayed punishment. Finally, Section \ref{Conclusions} discusses the broader implications of our results.
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{grafica_r1_w0_T0_Pool.eps}
...
The frequency ω, measured in inverse Monte Carlo Steps ($MCS^-1$), lets us explore different types of real-world fluctuations. Low frequencies might represent long-term economic cycles, while high frequencies could model rapid fluctuations like daily market volatility or random noise in the system.
...
We observed these patterns starting from $ω = 0.00001$, our lowest tested frequency. Interestingly, at even lower frequencies, punishers dominate the system. This occurs because we start our simulations with $\delta = 0$, meaning $r$ initially increases, giving cooperation an early advantage that becomes decisive over very long oscillation periods.
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{densidad_retardo_tau5.0_L100_T0_t5000_Pool.eps}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{freq_tiempo_retardoYsin_T0_r04.0_r10.5_tau50000_L100K0.5_t10000.eps}
...
Looking at Figure \ref{freq_retardo}, which shows the long-term frequency of each strategy with a delay of $τ=5$ MCS, we see a dramatic shift from our previous results. Comparing this to Figure \ref{densidad}(c) (the no-delay case), we observe two significant changes: (1) Punishers have almost completely disappeared across most values of the enhancement factor $r$ (2) While normal cooperators appear at lower $r$ values than before, defectors maintain a much stronger presence
...
\bibitem{Delay} 
A. K. Dal Bosco, D. Wolfersberger, and M. Sciamanna, EPL \textbf{101}, 24001 (2013). \url{https://doi.org/10.1209/0295-5075/101/24001}.
