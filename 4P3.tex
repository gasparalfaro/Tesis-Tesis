...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{Images/P3/Sequencia.eps}
    \caption{}
    \label{fig:Sequencia}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Images/P3/GranPlot.eps}
    \caption{}
    \label{fig:GranPlot}
\end{figure}
...
We have fitted this curves to the Weibull "stretched exponential" function:
\begin{equation}
    F(t;k,a)=1-e^{-(t/a)^k},
    \label{WeibullDistr}
\end{equation}
